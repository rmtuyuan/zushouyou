...
var index = {
        ...
        fetch("http://192.168.3.118/Api/Index/flash", {
            ...
            if (data.code == 200) {
                for (var i = 0; i < data.data.length; i++) {
                    ...
                    banner_html += `<li><a href="https://${element.url}"><img src="http://192.168.3.118${element.pic}" alt="${element.title}"></a></li>`;
                }
    ...
    noticeLoad: function () {
        // 公告
        fetch("http://192.168.3.118/Api/Index/translate", {
            method: 'POST',
            //headers:{"Content-type": "application/json; charset=UTF-8" },
            mode: 'cors'
            // cache: 'no-cache',
            ...
            $(".game-notice-ul").html(data.data.content);
