...
var accountList = {
    ...
    dataLoadFun: function (form) {
        ...
        <div class="container">
            ...
            <div class="account-msg-item self-msg-item">
                <b>租用倒计时:</b><p> <span class="time-count" data-time="${data.data.ball.stoptime}"> <b></b> : <b></b> : <b></b></span></p> <a href="account_detail.html?id=${data.data.ball.id}">立即租用</a>
            </div>
        </div>
    </div>`;
        ...
        <div class="container">
            ...
            <div class="account-msg-item self-msg-item">
                <b class="visi-hide">租用倒计时:</b><p class="visi-hide"> <span class="time-count" data-time="${element.stoptime}"> <b></b> : <b></b> : <b></b></span></p> <a href="account_detail.html?id=${element.id}">立即租用</a>
            </div>
        </div>
    </div>`;
        ...
        <div class="container">
            ...
            <div class="account-msg-item self-msg-item">
                <b >租用倒计时:</b><p > <span class="time-count" data-time="${element.stoptime}"> <b></b> : <b></b> : <b></b></span></p> <a  style='display;none;' href="account_detail.html?id=${element.id}">立即租用</a>
            </div>
        </div>
    </div>`;
                    } else {
